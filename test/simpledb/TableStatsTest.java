...
public class TableStatsTest extends SimpleDbTestBase {
	...
	@Before public void setUp() throws Exception {
		...
		this.f = SystemTestUtil.createRandomHeapFile(10, 102000, 32, null, tuples);
	...
	@Test public void estimateTableCardinalityTest() {
		...
		Assert.assertEquals(30600, s.estimateTableCardinality(0.3));
		
		// Make sure we get all rows with 100% selectivity, and none with 0%
		Assert.assertEquals(102000, s.estimateTableCardinality(1.0));
	...
	@Test public void estimateSelectivityTest() {
		final int maxCellVal = 32;	// Tuple values are randomized [0,maxCellVal)
    ...
    */
    public static junit.framework.Test suite() {
        return new JUnit4TestAdapter(TableStatsTest.class);
    }
}
